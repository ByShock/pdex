  ...
  render () {
    return (
      <div className='fullCard_container'>
        ...
        <div className='fullCard_close_button' onClick={this.props.closeCard}>
          X
        </div>
      </div>
    )
